...
INSERT INTO grocery_item (name, quantity, quantity_units, image, price, category, source)  VALUES ("Coca-Cola Soda Soft Drink", 8, 'oz', "coke.jpg", 1.67, "Soda", 'Walmart');
...
INSERT INTO grocery_item (name, quantity, quantity_units, image, price, category, source)  VALUES ("Dairy Farm Milk", 1, "carton", "milk_carton.png", 1.34, "Milk", 'Lehigh Valley Dairy Farm');
...
INSERT INTO grocery_item (name, quantity, quantity_units, image, price, category, source)  VALUES ("Coca-Cola Soda Soft Drink", 12, 'bottles', "coke_12_pack.jpg", 8.99, "Soda", 'Walmart');